...
import './WidgetsAnalytics.css';

const WidgetsAnalytics = () => {
    return (
        <div className='WidgetsAnalytics'>
            <h3 className='FeaturedAnalyticsTitle'>Events Distribution</h3>
            <div className="WidgetsAnalytics-container">
                <h5 className='Widgets-Subtitle'>Last 30 Days Performance</h5>
                {/* Total Count Svg  */}
                <svg
                    class="widgets-svg"
                    width="260"
                ...
                <div className="widgets-events">
                    <h5 className='subcontainer-title'>Events Distribution</h5>
                    <div className="widgets-subcontainer1">
                        <div className="subcontainer1-content">
                            <svg
                                width="35"
                                height="35"
                                viewBox="0 0 26 26"
                    ...
                    <div className="widgets-subcontainer2">
                        <div className="subcontainer1-content">
                            <svg
                                width="35"
                                height="35"
